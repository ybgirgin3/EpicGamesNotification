...
class EpicGames:
    ...
    def scrape(self) -> pd.DataFrame:
        ...
        return _extract_to_memory(
            resp.get("data").get("Catalog").get("searchStore").get("elements")
        )
...
def _sanitize_data(data: dict):
    ...
    if prom is not None:
        ...
        return {
            ...
            "game_release_date": iso_to_string(
                data.get("effectiveDate", "<unknown_game_release_date>")
            ),
